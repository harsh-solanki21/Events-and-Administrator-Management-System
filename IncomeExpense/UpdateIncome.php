...
session_start();
if(isset($_SESSION['update_income']))
{
    $_SESSION['update_income']=$_SESSION['update_income']+1;
}
else
{
    $_SESSION['update_income']=1;
}
$counter=$_SESSION['update_income'];
$sesid=$_SESSION['sid'];

$visit_counter = "UPDATE adminsession SET Edit_Income = $counter WHERE Session_id = $sesid";
...
if($_POST)
{
    ...
    {
        echo "<script>alert('Income Updated');window.location.href = 'View_IncomeExpense.php?year=$year';</script>";
