...
<html>
    ...
    <body>
    <center>
        <button onclick="window.location.href = 'Reports_Form_Pastor.php'">
            Upload File
        </button>
    ...
    <br>
    <?php
    $lc_qry = "SELECT Report_id, Report_date, Report_path, Reportmaker_name, Reportmaker_designation FROM reports WHERE Reportmaker_designation = 'Pastor'";
            ...
            <form method="POST">
                <table style="float: left; margin: 2%;">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <button formaction="DeleteReportsPastor.php" name="DelReports" value="<?php echo $row["Report_id"] ?>">
                                    Delete
                                </button>
